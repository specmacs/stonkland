...
/**
 * The flat isometric drawing, kept for anywhere a vector is wanted.
 *
 * Not what the interface shows any more: the commissioned renders replaced it. It stays
 * because it weighs nothing, scales to any size, and needs no network request.
 */
export function PieceDrawing({level, className = ""}: {level: number; className?: string}) {
  return (
    <svg
      viewBox="0 0 200 200"
      className={className}
