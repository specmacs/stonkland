  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-3xl px-4 pb-8 sm:px-6">
        ...
        <h2 className="mt-10 text-lg font-semibold text-ink-100">How this interface works</h2>
        ...
        <h2 className="mt-10 text-lg font-semibold text-ink-100">What a blockchain keeps</h2>
